...
const musicData = [
    {
        ...
        title:"Apana Bane Le",
        album:"Bhediya by Arjit Singh",
        year:2023,
        artist:"Arjit singh | Sachin-Jigar",
    ...
    },
    {
        ...
        album:"Shiddat",
        year:2021,
        artist:"Sachet Tandon | Sachin-Jigar",
    ...
    },
    {
        ...
        title:"Haaye Oye",
        album:"Qaran Ash king",
        year:2020,
        artist:"Qaran feat Ash King",
    ...
    },
    {
        ...
        title:"Malang Sajna",
        album:"Malang Sajna by Sachet-Parampara",
        year:2023,
    ...
    },
    {
        ...
        title:"Shiddat",
        album:"Shiddat by manan bhardwaj",
        year:2021,
    ...
    },
    {
        ...
        album:"Yaar Ni Milyaa",
        year:2016,
        artist:"Hardy Sandhu | B Praak",
        musicPath:"./assets/music/music-12.mp3",
    },
    
];

// add eventlistner on all elements that are passed
...
// playlist
// add all music in playlist from music data
...
// show 'playlist' modal sidebar when click on playlist button in top app bar and hide when click on overlay or any playlist-item
...
const getTimecode = function (duration){
    ...
    const timcode = `${minutes}:${seconds < 10 ? "0" : ""} ${seconds}`;
    return timcode
}
...
const rangeFil = document.querySelector("[data-ranfe-fill]");
